...
def build_parameter_registry(
    ...
    *,
    ...
    rows = [
        ...
        ParameterRecord("association_radius_cm", config.association_radius_cm, tuning, "same-tube prediction gate", True),
        ParameterRecord("static_model_tolerance_cm", config.static_model_tolerance_cm, tuning, "stationary-model residual gate", True),
        ParameterRecord("static_model_bad_frames", config.static_model_bad_frames, tuning, "consecutive residual failures before stop", True),
